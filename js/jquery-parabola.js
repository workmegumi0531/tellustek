(function () {
  ...
  Parabola.prototype = {
    ...
    initialize: function (options) {
      ...
      if (ops.targetEl) {
        this.driftX =
          toInteger(_$(ops.targetEl).css("left")) - this.elOriginalLeft;
        this.driftY =
          toInteger(_$(ops.targetEl).css("top")) - this.elOriginalTop;
      } else {
      ...
      // 于是
      this.b =
        (this.driftY - this.curvature * this.driftX * this.driftX) /
        this.driftX;
